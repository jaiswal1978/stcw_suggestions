    ...
    return (
        ...
        <div className="p-4 flex flex-col md:flex-row">
            <div className="md:flex-2/3 p-4">
                ...
                <p className='my-3 text-base md:text-lg lg:text-lg dm-serif-display-regular text-start text-blue-500' style={{letterSpacing: '3px'}}>
            ...
            <div className="md:flex-1/3 mt-4 md:mt-0 p-4 md:pt-20 text-start justify-between">
                ...
                <div className='bg-blue-400 text-white text-xl px-8 py-4 m-8 rounded-2xl'>
                    <h3 className='text-2xl font-bold text-yellow-300 mb-4 border-b-2 border-white'>
                        About Capt. Sudhir Subhedar
                    </h3>
                    <p>
                        Capt. Sudhir Subhedar, a member of The Company of Master Mariners of India (CMMI), who has firsthand experience in the creation of STCW 1978 and its subsequent revisions in 1995 and 2010, is seeking your practical insights. He aims to identify gaps in the current STCW and gather suggestions on what changes are desirable.
                    </p>
                </div>
            ...
            <div className="flex items-center justify-center">
                <Link to="/response-form" target="" className="bg-blue-600 hover:bg-blue-900 text-white font-bold py-5 px-10 rounded-2xl inline-block mx-2 my-4 text-lg md:text-xl lg:text-2xl text-center grow-shrink " style={{maxWidth: '300px'}}>Suggestion Form</Link>
